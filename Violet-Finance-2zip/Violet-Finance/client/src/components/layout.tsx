      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="border-t border-white/10 pt-12">
          ...
          <p className="text-[11px] text-white tracking-[0.2em] font-medium uppercase text-center">
             © 2025 Yek7pay. All rights reserved. | Powering <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-pink-500 font-black">Indias</span> Financial Future
          </p>
          <p className="text-[10px] text-white/60 text-center mt-3 max-w-4xl mx-auto leading-relaxed normal-case tracking-normal">
