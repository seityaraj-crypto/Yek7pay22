...
const plans = [
  {
    ...
    description: "Perfect for kirana stores, small retailers, and individual shop owners who need GST compliance plus digital financial services.",
    features: [
      "1 Year GST Filing (Normal Scheme)",
      "GST Registration Support",
      "Quarterly Return Filing (GSTR-1 & 3B)",
      "Domestic Money Transfer (DMT)",
      "UPI QR & mPOS Payments",
  ...
  },
  {
    ...
    description: "Ideal for MSMEs, traders, and businesses needing full GST compliance plus high-volume money transfer services.",
    features: [
      ...
      "Domestic Money Transfer (DMT) — High Limits",
      "Indo-Nepal Remittance",
      "AEPS & Micro ATM Services",
      "UPI QR, mPOS & PPI Wallet",
  ...
  },
  {
    ...
    description: "Complete GST, compliance & fintech package for corporates, Pvt. Ltd. companies, and high-volume businesses.",
    features: [
      ...
      "Domestic Money Transfer (DMT) — Unlimited",
      "Indo-Nepal Remittance — Priority",
      "AEPS, Micro ATM & PPI Wallet",
      "UPI QR, mPOS & Insurance Services",
      "Business Loans — Fast Approval",
      "Pvt. Ltd. / LLP Incorporation Support",
