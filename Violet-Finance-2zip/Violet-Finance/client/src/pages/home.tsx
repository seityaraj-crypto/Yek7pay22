...
export default function Home() {
  ...
  const dots = [
    { x: '3%', y: '12%', size: 'small' },
    { x: '8%', y: '28%', size: 'large' },
    { x: '15%', y: '18%', size: 'normal' },
    { x: '12%', y: '42%', size: 'normal' },
    { x: '22%', y: '32%', size: 'large' },
    { x: '28%', y: '15%', size: 'small' },
    { x: '32%', y: '48%', size: 'normal' },
    { x: '38%', y: '25%', size: 'large' },
    { x: '45%', y: '38%', size: 'normal' },
    { x: '52%', y: '22%', size: 'small' },
    { x: '48%', y: '55%', size: 'large' },
    { x: '58%', y: '35%', size: 'normal' },
    { x: '65%', y: '18%', size: 'normal' },
    { x: '62%', y: '48%', size: 'large' },
    { x: '72%', y: '28%', size: 'small' },
    { x: '78%', y: '42%', size: 'normal' },
    { x: '75%', y: '58%', size: 'large' },
    { x: '85%', y: '22%', size: 'normal' },
    { x: '82%', y: '35%', size: 'small' },
    { x: '88%', y: '52%', size: 'normal' },
    { x: '92%', y: '38%', size: 'large' },
    { x: '95%', y: '65%', size: 'small' },
    { x: '5%', y: '62%', size: 'normal' },
    { x: '18%', y: '72%', size: 'large' },
    { x: '25%', y: '58%', size: 'small' },
    { x: '35%', y: '68%', size: 'normal' },
    { x: '42%', y: '78%', size: 'large' },
    { x: '55%', y: '72%', size: 'normal' },
    { x: '68%', y: '68%', size: 'small' },
    { x: '78%', y: '75%', size: 'large' },
    { x: '88%', y: '82%', size: 'normal' },
  ];

  const connections = [
    { x1: '3%', y1: '12%', x2: '8%', y2: '28%' },
    { x1: '8%', y1: '28%', x2: '15%', y2: '18%' },
    { x1: '8%', y1: '28%', x2: '12%', y2: '42%' },
    { x1: '15%', y1: '18%', x2: '22%', y2: '32%' },
    { x1: '15%', y1: '18%', x2: '28%', y2: '15%' },
    { x1: '22%', y1: '32%', x2: '32%', y2: '48%' },
    { x1: '22%', y1: '32%', x2: '38%', y2: '25%' },
    { x1: '28%', y1: '15%', x2: '38%', y2: '25%' },
    { x1: '38%', y1: '25%', x2: '45%', y2: '38%' },
    { x1: '38%', y1: '25%', x2: '52%', y2: '22%' },
    { x1: '45%', y1: '38%', x2: '48%', y2: '55%' },
    { x1: '45%', y1: '38%', x2: '58%', y2: '35%' },
    { x1: '52%', y1: '22%', x2: '65%', y2: '18%' },
    { x1: '58%', y1: '35%', x2: '62%', y2: '48%' },
    { x1: '58%', y1: '35%', x2: '72%', y2: '28%' },
    { x1: '65%', y1: '18%', x2: '72%', y2: '28%' },
    { x1: '62%', y1: '48%', x2: '75%', y2: '58%' },
    { x1: '72%', y1: '28%', x2: '78%', y2: '42%' },
    { x1: '72%', y1: '28%', x2: '85%', y2: '22%' },
    { x1: '78%', y1: '42%', x2: '82%', y2: '35%' },
    { x1: '78%', y1: '42%', x2: '88%', y2: '52%' },
    { x1: '85%', y1: '22%', x2: '92%', y2: '38%' },
    { x1: '88%', y1: '52%', x2: '92%', y2: '38%' },
    { x1: '88%', y1: '52%', x2: '95%', y2: '65%' },
    { x1: '12%', y1: '42%', x2: '5%', y2: '62%' },
    { x1: '12%', y1: '42%', x2: '25%', y2: '58%' },
    { x1: '32%', y1: '48%', x2: '35%', y2: '68%' },
    { x1: '5%', y1: '62%', x2: '18%', y2: '72%' },
    { x1: '18%', y1: '72%', x2: '25%', y2: '58%' },
    { x1: '25%', y1: '58%', x2: '35%', y2: '68%' },
    { x1: '35%', y1: '68%', x2: '42%', y2: '78%' },
    { x1: '48%', y1: '55%', x2: '55%', y2: '72%' },
    { x1: '55%', y1: '72%', x2: '42%', y2: '78%' },
    { x1: '55%', y1: '72%', x2: '68%', y2: '68%' },
    { x1: '68%', y1: '68%', x2: '75%', y2: '58%' },
    { x1: '68%', y1: '68%', x2: '78%', y2: '75%' },
    { x1: '78%', y1: '75%', x2: '88%', y2: '82%' },
    { x1: '95%', y1: '65%', x2: '88%', y2: '82%' },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a1a3a] via-[#0d0d2b] to-[#1a0b3b] text-white relative">
      <div className="connected-dots-bg">
        ...
        {dots.map((dot, i) => (
          <div
            key={`dot-${i}`}
            className={`dot ${dot.size === 'small' ? 'small' : dot.size === 'large' ? 'large' : ''}`}
